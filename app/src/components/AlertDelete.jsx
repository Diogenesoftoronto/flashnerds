...
const AlertDelete = (props) => {
  ...
  const {state, setState, onDelete, id } = props;
  ...
  return (
  <AlertDialog open={state === "DELETE" ? 'open' : null}>
    <AlertDialogContent >
      <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
      <AlertDialogDescription>
        This action cannot be undone. Make sure you don't regret this...
      </AlertDialogDescription>
      <Flex css={{ justifyContent: 'flex-end' }}>
        {/* <AlertDialogCancel asChild> */}
          <Button onClick={cancel} variant="mauve" css={{ marginRight: 25 }}>
            Cancel
          </Button>
        {/* </AlertDialogCancel> */}
        {/* <AlertDialogAction asChild> */}
          <Button onClick={confirmDelete} variant="red">Yes, I want it gone</Button>
        {/* </AlertDialogAction> */}
      </Flex>
    </AlertDialogContent>
  </AlertDialog>
